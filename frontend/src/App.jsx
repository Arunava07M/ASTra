...
export default function App() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-950 font-sans relative">
      ...
      {showWelcome && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-950/70 backdrop-blur-xl animate-in fade-in duration-500">
          <div className="relative max-w-xl w-full bg-slate-900 border border-slate-700 p-8 rounded-2xl shadow-2xl text-slate-300">
